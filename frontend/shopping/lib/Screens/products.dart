    ...
    return BlocConsumer<MyshopCubit, MyshopState>(
      ...
      builder: (context, state) {
        ...
        return ConditionalBuilder(
          ...
          builder: (context) =>
              builderCarouselSlider(cubitHome!, cubitCategory!, context),
          fallback: (context) =>
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) =>
                builderCategory(modelCate.data!.data[index], context),
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon: CircleAvatar(
                      radius: 15,
                      backgroundColor:
                          MyshopCubit.get(context).favorits[modelProduct.id]!
                              ? defaultColor
                              : Colors.grey,
                      child: const Icon(
